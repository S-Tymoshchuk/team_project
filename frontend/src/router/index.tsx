...
const SignUpSuccessPage = React.lazy(() => import('../pages/auth-pages/signUpSuccess'));
const ForgotPassword = React.lazy(() => import('../pages/auth-pages/forgotPage'));
const ForgotPasswordSuccess = React.lazy(() => import('../pages/auth-pages/forgotPassSuccess'));
    ...
    return (
        <Router history={history}>
            <Suspense fallback={<Fallback/>}>
                <Switch>
                    {
                        props.auth ? (<Route exact path="/" component={HomePage}/>) : (
                            <>
                                <Route exact path="/" component={Login}/>
                                <Route exact path="/signup" component={Register}/>
                                <Route exact path="/signup/success" component={SignUpSuccessPage}/>
                                <Route exact path="/forgot" component={ForgotPassword}/>
                                <Route exact path="/forgot/success" component={ForgotPasswordSuccess}/>
                            </>
                        )
                    }
                </Switch>
